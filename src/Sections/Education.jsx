                        ...
                        <div className="space-y-12">
                            {education.map((edu, index) => (
                                <div key={index} className={`relative flex  items-center justify-between md:justify-normal w-full ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                                    <div className="absolute left-[20px] md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[var(--primary-color)] rounded-full shadow-[0_0_10px_var(--primary-color)] z-10"></div>
                                    <div className="flex-1 min-w-0 md:flex-none md:w-5/12 ml-10 md:ml-0 glass p-6 rounded-xl border border-[rgba(255,255,255,0.05)] hover:border-[var(--primary-color)] transition-all hover:shadow-[0_0_20px_rgba(0,229,255,0.1)]">
